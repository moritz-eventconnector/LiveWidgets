...
AUTHENTIK_ISSUER=$(prompt_with_default "AUTHENTIK_ISSUER (https://auth.example.com/application/o/livewidgets)" "$(get_env_value "AUTHENTIK_ISSUER" || true)")
AUTHENTIK_CLIENT_ID=$(prompt_with_default "AUTHENTIK_CLIENT_ID" "$(get_env_value "AUTHENTIK_CLIENT_ID" || true)")
AUTHENTIK_CLIENT_SECRET=$(prompt_with_default "AUTHENTIK_CLIENT_SECRET" "$(get_env_value "AUTHENTIK_CLIENT_SECRET" || true)")
